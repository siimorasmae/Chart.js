...
},{"./charts/Chart.Bar":8,"./charts/Chart.Line":9,"./controllers/controller.bar":10,"./controllers/controller.line":11,"./core/core.animation":12,"./core/core.controller":13,"./core/core.datasetController":14,"./core/core.element":15,"./core/core.helpers":16,"./core/core.js":17,"./core/core.layoutService":18,"./core/core.legend":19,"./core/core.plugin.js":20,"./core/core.scale":21,"./core/core.scaleService":22,"./core/core.title":23,"./core/core.tooltip":24,"./elements/element.arc":25,"./elements/element.line":26,"./elements/element.point":27,"./elements/element.rectangle":28,"./scales/scale.category":29,"./scales/scale.linear":30,"./scales/scale.linearbase.js":31,"./scales/scale.logarithmic":32,"./scales/scale.radialLinear":33,"./scales/scale.time":34}],8:[function(require,module,exports){
"use strict";
            ...
            helpers.each(this.data.datasets, function(dataset, datasetIndex) {
                if (this.isDatasetVisible(datasetIndex)) {
                    ...
                    helpers.each(meta.data, function(element, index) {
                        ...
                        if (eventPosition.x > meta.data[0]._view.x && eventPosition.x < meta.data[index]._view.x) {

                            var last = meta.data[index-1]._view.x;
                            var next = meta.data[index]._view.x;
                            var midpoint = (last + next)/2;

                            if (eventPosition.x < midpoint) {
                                elementsArray.push(meta.data[index-1]);
...
},{"chartjs-color":2}],17:[function(require,module,exports){
"use strict";
	...
	Chart.Scale = Chart.Element.extend({
		...
		draw: function(chartArea) {
			...
			if (this.isHorizontal()) {
				...
				var fullWidth = this.left + this.width;
				helpers.each(this.ticks, function (label, index) {
					var shouldSkip = (skipRatio > 1 && index % skipRatio > 0);
                    if (shouldSkip || (label === undefined || label === null)) {
						return;
					}
					var isLastTick = this.ticks.length === index + 1;
					var isLastViableTick = (index + skipRatio) >= this.ticks.length || isLastTick;
					...
					if (optionTicks.display) {
						var pushTextToLeftAmount = 0;
						if(isLastViableTick && xLabelValue > fullWidth - 17) {
							pushTextToLeftAmount = 17 - (fullWidth - xLabelValue);
						}
						context.save();
						context.translate((isLastViableTick) ? xLabelValue - pushTextToLeftAmount : xLabelValue + optionTicks.labelOffset, (isRotated) ? this.top + 12 : options.position === "top" ? this.bottom - tl : this.top + tl);
...
module.exports = function(Chart) {
	...
	Chart.elements.Point = Chart.Element.extend({
		inRange: function(mouseX, mouseY) {
			var vm = this._view;
			return vm ? (Math.abs(mouseX - vm.x) <= vm.hitRadius) : false;
		},
		inLabelRange: function(mouseX) {
			var vm = this._view;
